use std::fmt::format;
use anyhow::Error;
use poise::{command, send_reply, ChoiceParameter};
use serenity::all::UserId;
use crate::bot::Context;
use crate::bot::utils::msg::reply_success;
...
pub async fn set_balance(
	...
	reply_success(&ctx, "💵 Balance set!", format!("Successfully set {} balance of {user_name} to {balance}!", balance_type.to_str(), )).await?;
