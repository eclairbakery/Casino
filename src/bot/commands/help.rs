...
pub async fn help(
    ...
    ctx.send(CreateReply::default()
        .embed(serenity::CreateEmbed::new()
            ...
            .field("Komendy", "Generalnie na chwilę obecną możesz używać prawie każdej komendy oprócz hazardu jak w każdym innym bocie ekonomicznym tj. `bal`, `withdraw`, `work`, `slut`, `crime`, `deposit`, `ping`, `pay`, `rob`. Są też popularne aliasy, np. `deposit` -> `dep`. To dalej alpha, więc np. hazardu nie ma, ale chyba będzie (raczej).", false)
