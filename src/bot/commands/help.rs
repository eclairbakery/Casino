...
pub async fn help(
    ...
    ctx.send(CreateReply::default()
        .embed(serenity::CreateEmbed::new()
            ...
            .field("Hazard", "- **automaty**: Generalnie używasz `.slots` i możesz po tym podać kwotę jaką chcesz obstawić na automatach. Daje to bardzo duże zyski, ale jest mała szansa na wygraną...", false)
